...
void main()
{
	...
	uart_write((*tmp)&0x00ff);
	uart_write(((*tmp)&0xff00) >> 8);
	uart_write((*(tmp+1))&0x00ff);
	uart_write(((*(tmp+1))&0xff00) >> 8);
	uart_write((*(tmp+2))&0x00ff);
	uart_write(((*(tmp+2))&0xff00) >> 8);
	uart_write((*(tmp+3))&0x00ff);
	uart_write(((*(tmp+3))&0xff00) >> 8);
	uart_write((*(tmp+4))&0x00ff);
	uart_write(((*(tmp+4))&0xff00) >> 8);
	uart_write((*(tmp+5))&0x00ff);
	uart_write(((*(tmp+5))&0xff00) >> 8);
	uart_write((*(tmp+6))&0x00ff);
	uart_write(((*(tmp+6))&0xff00) >> 8);
	uart_write((*(tmp+7))&0x00ff);
	uart_write(((*(tmp+7))&0xff00) >> 8);
	uart_write((*(tmp+8))&0x00ff);
	uart_write(((*(tmp+8))&0xff00) >> 8);
	uart_write((*(tmp+9))&0x00ff);
	uart_write(((*(tmp+9))&0xff00) >> 8);
	uart_write((*(tmp+10))&0x00ff);
	uart_write(((*(tmp+10))&0xff00) >> 8);
