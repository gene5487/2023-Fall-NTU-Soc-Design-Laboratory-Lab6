...
void main()
{
	...
	int* tmp_f = fir();
	reg_mprj_datal = *tmp_f << 16;
	reg_mprj_datal = *(tmp_f+1) << 16;
	reg_mprj_datal = *(tmp_f+2) << 16;
	reg_mprj_datal = *(tmp_f+3) << 16;
	reg_mprj_datal = *(tmp_f+4) << 16;
	reg_mprj_datal = *(tmp_f+5) << 16;
	reg_mprj_datal = *(tmp_f+6) << 16;
	reg_mprj_datal = *(tmp_f+7) << 16;
	reg_mprj_datal = *(tmp_f+8) << 16;
	reg_mprj_datal = *(tmp_f+9) << 16;
...
/*
	...
	int *tmp_m = matmul();
	reg_mprj_datal = *tmp_m << 16;
	reg_mprj_datal = *(tmp_m+1) << 16;
	...
	reg_mprj_datal = *(tmp_q+7) << 16;
	reg_mprj_datal = *(tmp_q+8) << 16;
